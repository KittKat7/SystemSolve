...
import xyz.kittkat.systemsolve.ReadInstructions;
import xyz.kittkat.systemsolve.Resource;
...
public class ReadInstructionsTest {
	...
	public void testReadInstructionZero() {
		String[] expected = {
				"Hello and Welcome to System Solve!",
				"System Solve is an interactive learning platform",
